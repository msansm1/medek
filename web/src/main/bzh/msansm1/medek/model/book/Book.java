...
public class Book implements Serializable {
	...
	public Book(Integer id, String title, Integer editor, Integer collection,
			...
			String series, String book_nb, Boolean serie_done) {
		super();
		this.id = id;
		this.title = title;
		this.editor = editor;
	...
	public String getBook_nb() {
		return book_nb;
	}

	public void setBook_nb(String book_nb) {
		this.book_nb = book_nb;
	}
	...
	public String toString() {
		return "Book [id=" + id + ", title=" + title + ", editor=" + editor
				...
				+ series + ", book_nb=" + book_nb + ", serie_done="
				+ serie_done + "]";
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((book_nb == null) ? 0 : book_nb.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		Book other = (Book) obj;
		if (book_nb == null) {
			if (other.book_nb != null)
				return false;
		} else if (!book_nb.equals(other.book_nb))
			return false;
		if (collection == null) {
